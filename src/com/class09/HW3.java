...
public class HW3 extends CommonMethods {
	...
	Select sclctFromMonth=new Select(fromMonth);
	sclctFromMonth.selectByVisibleText("Dec");
	
	//Selecting a year
	WebElement fromYear=driver.findElement(By.xpath("//select//*[@class='ui-datepicker-year']"));
	Select sclctFromYear=new Select(fromYear);
	sclctFromYear.selectByVisibleText("2019");
	...
	Thread.sleep(3000);
	//clicking on the input to bring calendar view TO
	driver.findElement(By.id("callToDate")).click();
	WebElement toMonth=driver.findElement(By.xpath("//select[@class='ui-datepicker-month']"));
	Select sclctMonth=new Select(toMonth);
	sclctMonth.selectByVisibleText("Jan");
	WebElement toYear=driver.findElement(By.xpath("\"//select//*[@class='ui-datepicker-year']"));
	Select sclctToYear=new Select(toYear);
	sclctToYear.selectByVisibleText("2020");
	List<WebElement>toDate=driver.findElements(By.xpath("//table[@class='ui-datepicker-calendar']/tbody/tr"));
