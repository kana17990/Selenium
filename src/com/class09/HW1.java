...
for	(int i=1;i<=rows_f.size();i++) {
	...
	if(rowsText.contains("2017")) {
		...
		Thread.sleep(5000);
		System.out.println("Employee with id # " + empId + " has been sucessfully deleted");
		break;
	}
}
//if employee id was not found in the first page-->click next
